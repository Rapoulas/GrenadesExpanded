...
{
    public class TinyPlanetProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Vector2 vecToPlayer = owner.position - Projectile.Center;
            Projectile.velocity = Vector2.Lerp(Projectile.velocity, (Projectile.velocity * 40f + vecToPlayer) / 41f, 0.1f);
        }
